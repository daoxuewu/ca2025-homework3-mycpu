...
#define TOP_CLASS VRegisterFile
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/RegisterFile_should_correctly_read_previously_written_register_values/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_write_enable = u; break;
      case 2 : dut->io_write_address = u; break;
      case 3 : dut->io_write_data = u; break;
      case 4 : dut->io_read_address1 = u; break;
      case 5 : dut->io_read_address2 = u; break;
      case 6 : dut->io_debug_read_address = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_write_enable; break;
      case 2 : value = dut->io_write_address; break;
      case 3 : value = dut->io_write_data; break;
      case 4 : value = dut->io_read_address1; break;
      case 5 : value = dut->io_read_address2; break;
      case 6 : value = dut->io_debug_read_address; break;
      case 7 : value = dut->io_read_data1; break;
      case 8 : value = dut->io_read_data2; break;
      case 9 : value = dut->io_debug_read_data; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/RegisterFile_should_correctly_read_previously_written_register_values/RegisterFile.)";
