...
#define TOP_CLASS VInstructionFetch
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/InstructionFetch_should_correctly_update_PC_and_handle_jumps/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_jump_flag_id = u; break;
      case 2 : dut->io_jump_address_id = u; break;
      case 3 : dut->io_instruction_read_data = u; break;
      case 4 : dut->io_instruction_valid = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_jump_flag_id; break;
      case 2 : value = dut->io_jump_address_id; break;
      case 3 : value = dut->io_instruction_read_data; break;
      case 4 : value = dut->io_instruction_valid; break;
      case 5 : value = dut->io_instruction_address; break;
      case 6 : value = dut->io_instruction; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/InstructionFetch_should_correctly_update_PC_and_handle_jumps/InstructionFetch.)";
