...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/Single_Cycle_CPU__Integration_Tests_should_correctly_execute_recursive_Fibonacci10_program/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/Single_Cycle_CPU__Integration_Tests_should_correctly_execute_recursive_Fibonacci10_program/TestTopModule.)";
