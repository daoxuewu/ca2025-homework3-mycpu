...
#define TOP_CLASS VInstructionDecode
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/InstructionDecoder_should_decode_RV32I_instructions_and_generate_correct_control_signals/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 2 : value = dut->io_regs_reg1_read_address; break;
      case 3 : value = dut->io_regs_reg2_read_address; break;
      case 4 : value = dut->io_ex_immediate; break;
      case 5 : value = dut->io_ex_aluop1_source; break;
      case 6 : value = dut->io_ex_aluop2_source; break;
      case 7 : value = dut->io_memory_read_enable; break;
      case 8 : value = dut->io_memory_write_enable; break;
      case 9 : value = dut->io_wb_reg_write_source; break;
      case 10 : value = dut->io_reg_write_enable; break;
      case 11 : value = dut->io_reg_write_address; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/InstructionDecoder_should_decode_RV32I_instructions_and_generate_correct_control_signals/InstructionDecode.)";
