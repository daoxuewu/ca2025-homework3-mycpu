...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/Single_Cycle_CPU__Integration_Tests_should_correctly_handle_bytelevel_storeload_operations_SBLB/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_mem_debug_read_address = u; break;
      case 2 : dut->io_regs_debug_read_address = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_mem_debug_read_address; break;
      case 2 : value = dut->io_regs_debug_read_address; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/Single_Cycle_CPU__Integration_Tests_should_correctly_handle_bytelevel_storeload_operations_SBLB/TestTopModule.)";
