...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/Execute_should_execute_ALU_operations_and_branch_logic_correctly/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_instruction = u; break;
      case 2 : dut->io_instruction_address = u; break;
      case 3 : dut->io_reg1_data = u; break;
      case 4 : dut->io_reg2_data = u; break;
      case 5 : dut->io_immediate = u; break;
      case 6 : dut->io_aluop1_source = u; break;
      case 7 : dut->io_aluop2_source = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_instruction; break;
      case 2 : value = dut->io_instruction_address; break;
      case 3 : value = dut->io_reg1_data; break;
      case 4 : value = dut->io_reg2_data; break;
      case 5 : value = dut->io_immediate; break;
      case 6 : value = dut->io_aluop1_source; break;
      case 7 : value = dut->io_aluop2_source; break;
      case 8 : value = dut->io_mem_alu_result; break;
      case 9 : value = dut->io_if_jump_flag; break;
      case 10 : value = dut->io_if_jump_address; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/Execute_should_execute_ALU_operations_and_branch_logic_correctly/Execute.)";
