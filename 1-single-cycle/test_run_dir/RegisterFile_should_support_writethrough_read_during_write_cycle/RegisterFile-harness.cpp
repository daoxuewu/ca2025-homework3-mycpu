...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/RegisterFile_should_support_writethrough_read_during_write_cycle/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/nsda/chisel-tutorial/ca2025-mycpu/1-single-cycle/test_run_dir/RegisterFile_should_support_writethrough_read_during_write_cycle/RegisterFile.)";
